...
class TestOswErrorHandling(TestCase):

    def test_simple_internal_clock(self):
        osw_dir_path = os.path.join(os.path.dirname(__file__), 'models', 'osw_error_after_warmup')
        ...
        # Do we want to check for "Error" status?  This osw throws an error immediately after switching to "Running" status.
