...
/opt/scripts/wait-for-it.sh --strict -t 0 minio:9000

echo "Waiting for redis to start"
/opt/scripts/wait-for-it.sh --strict redis:6379

echo "Waiting for mongo to start"
/opt/scripts/wait-for-it.sh --strict mongo:27017
...
then
  ...
  /opt/scripts/wait-for-it.sh --strict influxdb:8086

  echo "Waiting for grafana to start"
  /opt/scripts/wait-for-it.sh --strict grafana:3000
else
